...
#pragma pack(pop)
    ...
    public:
        ...
        {
            NSR_UNUSED(appID);
            if (depots && maxDepots > 0) depots[0] = kNS3AppId;
    ...
    private:
        ...
        std::string m_Product = "NarutoStorm3Revived";
    ...
    public:
        ...
        virtual uint32_t GetAppID() { TraceCore("SteamUtils", "GetAppID"); return kNS3AppId; }
    ...
    public:
        ...
        virtual void* GetISteamNetworking(HSteamUser user, HSteamPipe pipe, const char* version) { SteamVersionLogger::LogInterfaceRequest("OfflineSteamClient::GetISteamNetworking", version); NSR_UNUSED(user); NSR_UNUSED(pipe); return NS3Revived_SteamNetworking(); }
...
namespace FakeSteamCore
{
    bool Init()
    {
        ...
        g_UserDataFolder = (std::filesystem::path(g_InstallPath) / "NarutoStorm3Revived" / "userdata").string();
