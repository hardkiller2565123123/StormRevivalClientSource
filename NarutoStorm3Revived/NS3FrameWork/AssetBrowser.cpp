...
namespace AssetBrowser
{
    bool Init()
    {
        ...
        g_ModsFolder = (std::filesystem::path(g_GameFolder) / "NarutoStorm3Revived" / "mods").string();
        g_DumpFolder = (std::filesystem::path(g_GameFolder) / "NarutoStorm3Revived" / "Dump").string();
        g_ToolsFolder = (std::filesystem::path(g_GameFolder) / "NarutoStorm3Revived" / "Tools").string();
        g_CacheFolder = (std::filesystem::path(g_GameFolder) / "NarutoStorm3Revived" / "Cache").string();
