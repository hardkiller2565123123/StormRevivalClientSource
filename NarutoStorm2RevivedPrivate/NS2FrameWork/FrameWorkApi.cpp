...
namespace
{
    ...
    void EnsureInitialized()
    {
        ...
        Logger::Init();
        Logger::Info("NS2FrameWork.dll add-on initialized");
        ...
        Logger::Info("NS2FrameWork.dll asset tools initialized");
        g_Initialized = true;
    }
}
...
{
    Logger::Info("NS2FrameWork.dll render-target reset requested; client owns the active swapchain.");
}
...
extern "C" __declspec(dllexport) void __cdecl Framework_OnClientGui()
{
    ...
    ImGui::Text("NS2FrameWork.dll Options");
    ImGui::Separator();
...
extern "C" __declspec(dllexport) void __cdecl Framework_OnClientShutdown()
{
    ...
    Logger::Info("NS2FrameWork.dll add-on shutdown");
    g_Initialized = false;
}
