...
namespace
{
    constexpr uint64_t kOfflineGameID = 543870;
    ...
    std::string LeaderboardPath()
    {
        ...
        std::filesystem::path out = base.parent_path() / "NartuoStorm2Revived" / "leaderboards.ini";
    ...
    {
        std::string value = name && name[0] ? name : "NS2RevivedLeaderboard";
    ...
    std::vector<LeaderboardEntryStub> SnapshotLeaderboardRows(SteamLeaderboard_t leaderboard)
    {
        ...
        {
            const std::string fallback = "NS2RevivedLeaderboard";
    ...
    std::string LeaderboardNameForHandle(SteamLeaderboard_t leaderboard)
    {
        ...
        return it == g_LeaderboardNames.end() ? "NS2RevivedLeaderboard" : it->second;
    }
...
public:
    ...
    virtual const char* GetLeaderboardName(SteamLeaderboard_t leaderboard)
    {
        ...
        static thread_local std::string s_Name;
        {
            ...
            s_Name = it == g_LeaderboardNames.end() ? "NS2RevivedLeaderboard" : it->second;
        }
