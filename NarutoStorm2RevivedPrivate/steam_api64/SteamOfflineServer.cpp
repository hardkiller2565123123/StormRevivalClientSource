...
namespace
{
    constexpr const char* kMagic = "NS2REVIVED_LOBBY_V1";
    ...
    std::string HashPasswordInternal(const std::string& password, const std::string& roomCode)
    {
        ...
        std::string material = normalizedRoom + ":" + password + ":NS2REVIVED";
        ...
        const sockaddr_in& from)
    {
        ...
        record.Name = ReadString(values, "name", "NS2 Revived LAN Lobby");
