...
extern "C" __declspec(dllexport) bool __cdecl SteamAPI_ISteamUser_GetUserDataFolder(void* self, char* buffer, int bufferSize)
{
    ...
    const std::string folder = (std::filesystem::path(FakeSteamCore::InstallPath()) / "NartuoStorm2Revived" / "userdata").string();
...
extern "C" __declspec(dllexport) void* __cdecl SteamAPI_ISteamClient_GetISteamNetworking(void* self, HSteamUser user, HSteamPipe pipe, const char* version)
{
    ...
    NSR_UNUSED(pipe);
    NSR_UNUSED(version);
    return NS2Revived_SteamNetworking();
}
...
extern "C" __declspec(dllexport) bool __cdecl SteamAPI_ISteamMatchmaking_GetFavoriteGame(void* self, int game, AppId_t* appID, uint32_t* ip, uint16_t* connPort, uint16_t* queryPort, uint32_t* flags, uint32_t* lastPlayed)
{
    NSR_UNUSED(self);
    NSR_UNUSED(game);
    FlatSafeWrite(appID, static_cast<AppId_t>(543870));
    FlatSafeWrite(ip, 0u);
...
// Custom networking
extern "C" __declspec(dllexport) void* __cdecl SteamNetworking() { SteamVersionLogger::LogExportRequest("SteamNetworking"); return NS2Revived_SteamNetworking(); }
extern "C" __declspec(dllexport) void* __cdecl SteamNetworkingMessages() { SteamVersionLogger::LogExportRequest("SteamNetworkingMessages"); return NS2Revived_SteamNetworkingMessages(); }
extern "C" __declspec(dllexport) void* __cdecl SteamNetworkingSockets() { SteamVersionLogger::LogExportRequest("SteamNetworkingSockets"); return NS2Revived_SteamNetworkingSockets(); }
extern "C" __declspec(dllexport) void* __cdecl SteamNetworkingUtils() { SteamVersionLogger::LogExportRequest("SteamNetworkingUtils"); return NS2Revived_SteamNetworkingUtils(); }
...
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamNetworking_v005, NS2Revived_SteamNetworking())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamGameServerNetworking_v006, NS2Revived_SteamGameServerNetworking())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamGameServerNetworking_v005, NS2Revived_SteamGameServerNetworking())
