...
namespace
{
    constexpr uint64_t kOfflineGameID = 495140;
    ...
    std::string LeaderboardPath()
    {
        ...
        std::filesystem::path out = base.parent_path() / "NarutoStorm1Revived" / "leaderboards.ini";
    ...
    {
        std::string value = name && name[0] ? name : "NS1RevivedLeaderboard";
    ...
    std::vector<LeaderboardEntryStub> SnapshotLeaderboardRows(SteamLeaderboard_t leaderboard)
    {
        ...
        {
            const std::string fallback = "NS1RevivedLeaderboard";
    ...
    std::string LeaderboardNameForHandle(SteamLeaderboard_t leaderboard)
    {
        ...
        return it == g_LeaderboardNames.end() ? "NS1RevivedLeaderboard" : it->second;
    }
...
public:
    ...
    virtual const char* GetLeaderboardName(SteamLeaderboard_t leaderboard)
    {
        ...
        static thread_local std::string s_Name;
        {
            ...
            s_Name = it == g_LeaderboardNames.end() ? "NS1RevivedLeaderboard" : it->second;
        }
