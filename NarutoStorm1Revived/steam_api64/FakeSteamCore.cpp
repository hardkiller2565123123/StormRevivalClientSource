...
namespace
{
    ...
    constexpr AppId_t kNS1AppId = 495140;
...
#pragma pack(pop)
    ...
    void* RouteVersion(const char* version)
    {
        ...
        if (HasInterface(u, "STEAMNETWORKINGMESSAGES")) return NS1Revived_SteamNetworkingMessages();
        if (HasInterface(u, "STEAMNETWORKINGSOCKETS")) return NS1Revived_SteamNetworkingSockets();
        if (HasInterface(u, "STEAMNETWORKINGUTILS")) return NS1Revived_SteamNetworkingUtils();
        if (HasInterface(u, "STEAMNETWORKING")) return NS1Revived_SteamNetworking();
    ...
    public:
        ...
        {
            NSR_UNUSED(appID);
            if (depots && maxDepots > 0) depots[0] = kNS1AppId;
    ...
    private:
        ...
        std::string m_Product = "NarutoStorm1Revived";
    ...
    public:
        ...
        virtual uint32_t GetAppID() { TraceCore("SteamUtils", "GetAppID"); return kNS1AppId; }
    ...
    public:
        ...
        virtual void* GetISteamNetworking(HSteamUser user, HSteamPipe pipe, const char* version) { SteamVersionLogger::LogInterfaceRequest("OfflineSteamClient::GetISteamNetworking", version); NSR_UNUSED(user); NSR_UNUSED(pipe); return NS1Revived_SteamNetworking(); }
...
namespace FakeSteamCore
{
    bool Init()
    {
        ...
        g_UserDataFolder = (std::filesystem::path(g_InstallPath) / "NarutoStorm1Revived" / "userdata").string();
