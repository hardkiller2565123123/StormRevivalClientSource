...
extern "C" void* __cdecl NS1Revived_SteamNetworking();
extern "C" void* __cdecl NS1Revived_SteamGameServerNetworking();
extern "C" void* __cdecl NS1Revived_SteamNetworkingUtils();
extern "C" void* __cdecl NS1Revived_SteamNetworkingMessages();
extern "C" void* __cdecl NS1Revived_SteamNetworkingSockets();
extern "C" void* __cdecl NS1Revived_SteamGameServerNetworkingSockets();
...
extern "C" __declspec(dllexport) bool __cdecl SteamAPI_ISteamUser_GetUserDataFolder(void* self, char* buffer, int bufferSize)
{
    ...
    const std::string folder = (std::filesystem::path(FakeSteamCore::InstallPath()) / "NarutoStorm1Revived" / "userdata").string();
...
extern "C" __declspec(dllexport) SteamAPICall_t __cdecl SteamAPI_ISteamUser_RequestEncryptedAppTicket(void* self, void* data, int dataSize)
{
    ...
    const char prefix[] = "NS1REVIVED_ENCRYPTED_APP_TICKET";
...
extern "C" __declspec(dllexport) void* __cdecl SteamAPI_ISteamClient_GetISteamNetworking(void* self, HSteamUser user, HSteamPipe pipe, const char* version)
{
    ...
    NSR_UNUSED(pipe);
    NSR_UNUSED(version);
    return NS1Revived_SteamNetworking();
}
...
extern "C" __declspec(dllexport) bool __cdecl SteamAPI_ISteamMatchmaking_GetFavoriteGame(void* self, int game, AppId_t* appID, uint32_t* ip, uint16_t* connPort, uint16_t* queryPort, uint32_t* flags, uint32_t* lastPlayed)
{
    NSR_UNUSED(self);
    NSR_UNUSED(game);
    FlatSafeWrite(appID, static_cast<AppId_t>(495140));
    FlatSafeWrite(ip, 0u);
...
// Custom networking
extern "C" __declspec(dllexport) void* __cdecl SteamNetworking() { SteamVersionLogger::LogExportRequest("SteamNetworking"); return NS1Revived_SteamNetworking(); }
extern "C" __declspec(dllexport) void* __cdecl SteamNetworkingMessages() { SteamVersionLogger::LogExportRequest("SteamNetworkingMessages"); return NS1Revived_SteamNetworkingMessages(); }
extern "C" __declspec(dllexport) void* __cdecl SteamNetworkingSockets() { SteamVersionLogger::LogExportRequest("SteamNetworkingSockets"); return NS1Revived_SteamNetworkingSockets(); }
extern "C" __declspec(dllexport) void* __cdecl SteamNetworkingUtils() { SteamVersionLogger::LogExportRequest("SteamNetworkingUtils"); return NS1Revived_SteamNetworkingUtils(); }
...
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamNetworking_v006, NS1Revived_SteamNetworking())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamNetworking_v005, NS1Revived_SteamNetworking())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamGameServerNetworking_v006, NS1Revived_SteamGameServerNetworking())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamGameServerNetworking_v005, NS1Revived_SteamGameServerNetworking())
...
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamNetworkingMessages_v002, NS1Revived_SteamNetworkingMessages())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamNetworkingMessages_SteamAPI_v002, NS1Revived_SteamNetworkingMessages())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamGameServerNetworkingMessages_v002, NS1Revived_SteamNetworkingMessages())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamGameServerNetworkingMessages_SteamAPI_v002, NS1Revived_SteamNetworkingMessages())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamNetworkingSockets_SteamAPI_v012, NS1Revived_SteamNetworkingSockets())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamGameServerNetworkingSockets_SteamAPI_v012, NS1Revived_SteamGameServerNetworkingSockets())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamNetworkingSockets_SteamAPI_v011, NS1Revived_SteamNetworkingSockets())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamGameServerNetworkingSockets_SteamAPI_v011, NS1Revived_SteamGameServerNetworkingSockets())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamNetworkingSockets_SteamAPI_v009, NS1Revived_SteamNetworkingSockets())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamGameServerNetworkingSockets_SteamAPI_v009, NS1Revived_SteamGameServerNetworkingSockets())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamNetworkingSockets_v009, NS1Revived_SteamNetworkingSockets())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamGameServerNetworkingSockets_v009, NS1Revived_SteamGameServerNetworkingSockets())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamNetworkingSockets_v008, NS1Revived_SteamNetworkingSockets())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamGameServerNetworkingSockets_v008, NS1Revived_SteamGameServerNetworkingSockets())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamNetworkingUtils_SteamAPI_v003, NS1Revived_SteamNetworkingUtils())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamNetworkingUtils_SteamAPI_v004, NS1Revived_SteamNetworkingUtils())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamNetworkingUtils_v003, NS1Revived_SteamNetworkingUtils())
...
extern "C" __declspec(dllexport) void* __cdecl SteamGameServerNetworking() { return NS1Revived_SteamGameServerNetworking(); }
extern "C" __declspec(dllexport) void* __cdecl SteamGameServerNetworkingSockets() { return NS1Revived_SteamGameServerNetworkingSockets(); }
