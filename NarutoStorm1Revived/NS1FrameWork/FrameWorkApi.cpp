...
namespace
{
    ...
    void EnsureInitialized()
    {
        ...
        Logger::Init();
        Logger::Info("NS1FrameWork.dll add-on initialized");
        ...
        Logger::Info("NS1FrameWork.dll asset tools initialized");
        g_Initialized = true;
    }
}
...
{
    Logger::Info("NS1FrameWork.dll render-target reset requested; client owns the active swapchain.");
}
...
extern "C" __declspec(dllexport) void __cdecl Framework_OnClientGui()
{
    ...
    ImGui::Text("NS1FrameWork.dll Options");
    ImGui::Separator();
...
extern "C" __declspec(dllexport) void __cdecl Framework_OnClientShutdown()
{
    ...
    Logger::Info("NS1FrameWork.dll add-on shutdown");
    g_Initialized = false;
}
