...
namespace AssetBrowser
{
    bool Init()
    {
        ...
        g_ModsFolder = (std::filesystem::path(g_GameFolder) / "NarutoStorm1Revived" / "mods").string();
        g_DumpFolder = (std::filesystem::path(g_GameFolder) / "NarutoStorm1Revived" / "Dump").string();
        g_ToolsFolder = (std::filesystem::path(g_GameFolder) / "NarutoStorm1Revived" / "Tools").string();
        g_CacheFolder = (std::filesystem::path(g_GameFolder) / "NarutoStorm1Revived" / "Cache").string();
