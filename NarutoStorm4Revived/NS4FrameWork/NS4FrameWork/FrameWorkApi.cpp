...
namespace
{
    ...
    void EnsureInitialized()
    {
        ...
        Logger::Init();
        Logger::Info("NS4FrameWork.dll add-on initialized");
        ...
        Logger::Info("NS4FrameWork.dll asset tools initialized");
        g_Initialized = true;
    }
}
...
{
    Logger::Info("NS4FrameWork.dll render-target reset requested; client owns the active swapchain.");
}
...
namespace
{
    ...
    void DrawFrameworkLeftNav()
    {
        ...
        case FW_DEVTOOLS:
            ...
            DrawLeftButton("Scene Viewer", 1);
            DrawLeftButton("Network", 2);
            DrawLeftButton("Content", 3);
            DrawLeftButton("Mods", 4);
            DrawLeftButton("Memory", 5);
            DrawLeftButton("Media", 6);
            DrawLeftButton("Console", 7);
            break;
        }
    }
    ...
    void DrawFrameworkPage()
    {
        ...
        case FW_DEVTOOLS: DevToolsManager::DrawPage(); break;
        }
    }
...
extern "C" __declspec(dllexport) void __cdecl Framework_OnClientGui()
{
    ...
    ImGui::Text("NS4FrameWork.dll Options");
    ImGui::Separator();
    ...
    DrawFrameworkTab("Patches", FW_PATCHES); ImGui::SameLine();
    DrawFrameworkTab("DevTools", FW_DEVTOOLS);

    ImGui::Separator();

    DevToolsManager::TickHotkeys();
...
extern "C" __declspec(dllexport) void __cdecl Framework_OnClientShutdown()
{
    ...
    Logger::Info("NS4FrameWork.dll add-on shutdown");
    g_Initialized = false;
}
