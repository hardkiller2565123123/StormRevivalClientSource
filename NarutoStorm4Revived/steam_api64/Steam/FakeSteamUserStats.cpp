...
namespace
{
    constexpr uint64_t kOfflineGameID = 349040;
    ...
    std::string LeaderboardPath()
    {
        ...
        std::filesystem::path out = base.parent_path() / "NarutoStorm4Revived" / "leaderboards.ini";
    ...
    {
        std::string value = name && name[0] ? name : "NS4RevivedLeaderboard";
    ...
    std::vector<LeaderboardEntryStub> SnapshotLeaderboardRows(SteamLeaderboard_t leaderboard)
    {
        ...
        {
            const std::string fallback = "NS4RevivedLeaderboard";
    ...
    std::string LeaderboardNameForHandle(SteamLeaderboard_t leaderboard)
    {
        ...
        return it == g_LeaderboardNames.end() ? "NS4RevivedLeaderboard" : it->second;
    }
...
public:
    ...
    virtual const char* GetLeaderboardName(SteamLeaderboard_t leaderboard)
    {
        ...
        static thread_local std::string s_Name;
        {
            ...
            s_Name = it == g_LeaderboardNames.end() ? "NS4RevivedLeaderboard" : it->second;
        }
