...
public:
	...
	static __int64 __fastcall GetCoordByFullName(__int64 gObj, __int64 a2, unsigned int a3)
	{
		if (GameVersion && std::strcmp(GameVersion, "1.60") == 0) {
			typedef __int64(__fastcall* funct)(__int64 gObj, __int64 a2, unsigned int a3);
			funct fc = (funct)(moduleBase + 0x5EFC00);
			return fc(gObj, a2, a3);
		}
		else if (GameVersion && std::strcmp(GameVersion, "1.09") == 0) {

			typedef __int64(__fastcall* funct)(__int64 gObj, __int64 a2, unsigned int a3);
			funct fc = (funct)(moduleBase + 0x5577A8);
			return fc(gObj, a2, a3);
		}
