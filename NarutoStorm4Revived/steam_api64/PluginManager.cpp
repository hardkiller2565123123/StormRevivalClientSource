...
{
	Unload();
	std::cout << "UltimateStormAPI :: Freeing " + pluginPath << std::endl;
...
{
	std::cout << "UltimateStormAPI :: Attempting to reload " + pluginPath << std::endl;
	...
	if (hInstance)
	{
		...
		else std::cout << "UltimateStormAPI :: InitializePlugin() function not found" << std::endl;
	...
	std::cout << "UltimateStormAPI :: Reloaded plugin sucessfully" << std::endl;
}
