...
vector<const char*> CpkLoader::CpkToLoad;
vector<int> CpkLoader::CpkPriority;

int CpkLoader::LoadCpkInitial()
{
	__int64 v0; // rax@1
	__int64 v1; // rbx@1
	...
	v0 = (__int64)&retaddr;
	v1 = Common::GetQword(0x1416663C8);
	if (!v1) return v0;

	if (Common::GetDword(0x1415F8244) != 1)
	{
		// 0x1CD368 addstring to buffer
		typedef signed __int64(__fastcall * fc_AddStringToBuffer)(__int64 a, __int64 b);
		fc_AddStringToBuffer AddStringToBuffer = (fc_AddStringToBuffer)(moduleBase + 0x1CD368);
		AddStringToBuffer((__int64)&Memory, Common::GetOffset(0x1557E58));
		v7 = &Memory;
		...
		sub_140A47CF0 sub_140A47CF0_f = (sub_140A47CF0)(moduleBase + 0xA470F0);
		...
		if (v16 >= 0x10)
		{
			...
			sub_140A01D60 sub_140A01D60_f = (sub_140A01D60)(moduleBase + 0xA01160);
			v9 = sub_140A01D60_f((__int64)&v17);

			// 0xA01080
			typedef signed __int64(__fastcall * nuccMemoryType__Function01)(__int64 a);
			nuccMemoryType__Function01 nuccMemoryType__Function01_f = (nuccMemoryType__Function01)(moduleBase + 0xA01080);
			nuccMemoryType__Function01(v9);

			// 0xA00EA0
			typedef void(__fastcall * sub_140A01AA0)(__int64 a);
			sub_140A01AA0 sub_140A01AA0_f = (sub_140A01AA0)(moduleBase + 0xA00EA0);
			sub_140A01AA0(v8);

			// 0xA01050
			typedef signed __int64(__fastcall * nuccMemoryUnknown__PopCurrent)();
			nuccMemoryUnknown__PopCurrent nuccMemoryUnknown__PopCurrent_f = (nuccMemoryUnknown__PopCurrent)(moduleBase + 0xA01050);
	...
	// LOAD PATCH
	{
		...
		sub_14056C3D4 sub_14056C3D4_f = (sub_14056C3D4)(moduleBase + 0x56B7D4);
	...
	// LOAD BASE GAME CPK
	{
		...
		do
		{
			...
			sub_14056C34C sub_14056C34C_f = (sub_14056C34C)(moduleBase + 0x56B74C);
	...
	if (Common::GetQword(0x1416663C8))
		region = *(int*)(Common::GetQword(0x1416663C8) + 0x1D4);
		...
		default:
			{
				...
				if (!Common::GetQword(0x1416759C8))
					goto LABEL_17;

				// 0xA31EB0
				typedef signed __int64(__fastcall * sub_140A32AB0)(__int64 a, __int64 b, __int64 c);
				sub_140A32AB0 sub_140A32AB0_f = (sub_140A32AB0)(moduleBase + 0xA31EB0);
				sub_140A32AB0_f(Common::GetQword(0x1416759C8), (__int64)"disc:data/launch/LANG/dataRegion.cpk", (__int64)&v27);
...
LABEL_17:
	// LOAD CUSTOM CPK
	{
		...
		for (int x = 0; x < CpkToLoad.size(); x++)
		{
			...
			cout << "CpkLoader :: Loaded cpk " << CpkToLoad.at(x) << " with priority " << std::hex << std::uppercase << GameVersion << endl;
	...
	if (Common::GetQword(0x1415F8298))
	{
		//v11 = (const char *)1001;
		//v12 = 1003;
		...
		sub_14056BE84 sub_14056BE84_f = (sub_14056BE84)(moduleBase + 0x56B284);
		v0 = sub_14056BE84_f(Common::GetQword(0x1415F8298));
	}

	std::cout << "CpkLoader :: Finished loading cpk files" << std::endl;
