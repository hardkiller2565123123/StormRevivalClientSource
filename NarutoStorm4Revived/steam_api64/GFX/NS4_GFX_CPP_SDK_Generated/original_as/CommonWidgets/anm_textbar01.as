package script.result_main
{
   ...
   public class anm_textbar01 extends MovieClip
   {
      
      public var mc_barbase1:smb_frame_bar1_1;
      
      public var mc_barbase2:smb_frame_bar1_2;
      ...
      private var m_txtSf:smb_font = null;
      
      private var m_rate:MovieClip = null;
      
      private var m_isChangedLayout:Boolean = false;
      
      public function anm_textbar01()
      {
         super();
         ...
         this.m_txtSf = this["txt_sf"];
         this.m_rate = this["mc_rate"];
      }
      ...
      private function CheckArabicLayout() : Boolean
      {
         ...
         if(this.m_txtRslt.IsArabic() == true)
         {
            if(this.m_isChangedLayout == false)
            {
               ...
               {
                  _loc1_ = this["mc_barbase2"];
                  if(_loc1_ != null)
                  {
                     _loc4_ = _loc1_.x;
                  }
               }
               this.m_rate.x += (_loc4_ - this.m_rate.x) * 2;
               _loc2_ = new Point();
               ...
               this.m_txtSf.GetTextPos(_loc2_);
               this.m_txtSf.SetTextPos(_loc2_.x + (_loc4_ - _loc2_.x) * 2,_loc2_.y);
               _loc3_ = new Point();
            ...
            this.m_txtSf.SetTextAlign(smb_font.CCD_ALIGN_RIGHT);
            this.m_txtSf.SetTextPivot(smb_font.CCD_PIVOT_LC);
      ...
      internal function frame1() : *
      {
         ...
         this.txt_rslt.SetTextFieldWidth(445);
         this.txt_rslt.SetTextFit(true);
         this.txt_rslt.SetTextColor(smb_font.CCD_COLOR_WHITE);
         this.txt_rslt.DisableDropShadowFilter();
         this.txt_sf.SetTextPivot(smb_font.CCD_PIVOT_RC);
         this.txt_sf.SetTextSize(22);
         this.txt_sf.SetTextColor(smb_font.CCD_COLOR_WHITE);
         this.txt_sf.DisableDropShadowFilter();
