package script.hist_cmn
{
   ...
   public class nut_lst_c_b4_1 extends start_list_base
   {
      ...
      public function nut_lst_c_b4_1()
      {
         super();
      ...
      override public function CreateStartPointList() : *
      {
         ...
         m_startPointList.push(MovieClip(this["mc_c3"]));
         m_startPointList.push(MovieClip(this["mc_btl4"]));
         m_startPointList.push(MovieClip(this["mc_c4"]));
      }
