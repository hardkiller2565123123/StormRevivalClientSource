package script.duel_boss
{
   ...
   public class anm_up_re extends MovieClip
   {
      ...
      public function anm_up_re()
      {
         var _loc2_:anm_up_ok = null;
         this.m_gaugeIcon = new Array();
         this.m_okEffect = new Array();
         super();
         addFrameScript(10,this.frame11,15,this.frame16,20,this.frame21,23,this.frame24,34,this.frame35,40,this.frame41);
