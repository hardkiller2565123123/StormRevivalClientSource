package script.duel_boss_help
{
   ...
   public class nut_help_boss13phase01
   {
      
      public static const CCD_KEY_ATK:int = Enum.Next(0);
      
      public static const CCD_KEY_GRD:int = Enum.Next();
      
      public static const CCD_KEY_KRJ:int = Enum.Next();
      
      public static const CCD_KEY_SKL:int = Enum.Next();
      
      public static const CCD_KEY_CHD:int = Enum.Next();
      
      public static const CCD_KEY_JMP:int = Enum.Next();
      
      public static const CCD_KEY_CHC:int = Enum.Next();
      
      public static const CCD_KEY_SRK:int = Enum.Next();
      ...
      public function nut_help_boss13phase01()
      {
         super();
         var _loc1_:int = 0;
