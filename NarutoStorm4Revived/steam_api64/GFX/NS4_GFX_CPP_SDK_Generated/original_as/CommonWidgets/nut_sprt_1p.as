package script.gauge_sprt
{
   ...
   public class nut_sprt_1p extends MovieClip
   {
      ...
      public function nut_sprt_1p()
      {
         super();
         addFrameScript(0,this.frame1,9,this.frame10,18,this.frame19,28,this.frame29,45,this.frame46,62,this.frame63,63,this.frame64,80,this.frame81,89,this.frame90,98,this.frame99,107,this.frame108);
      ...
      public function Update(param1:Event) : *
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         var _loc2_:int = this.mc_gauge1.totalFrames;
         var _loc3_:int = this.m_gaugeRateL * _loc2_;
         ...
         if(this.m_memberNum == 3)
         {
            ...
            _loc5_ = this.m_gaugeRateR * _loc4_;
      ...
      public function LoadIcon() : *
      {
         ...
         this.m_loaderL[this.m_memberNum - 1].contentLoaderInfo.addEventListener(Event.COMPLETE,function(param1:Event):void
         {
            ...
            while(_loc2_ < m_memberNum)
            {
               ...
               if(m_memberNum == 3)
               {
                  dmy_char2.addChild(m_loaderR[_loc2_]);
               }
               _loc2_++;
            }
         });
         this.m_loaderAwakeL[this.m_memberNum - 1].contentLoaderInfo.addEventListener(Event.COMPLETE,function(param1:Event):void
         {
            ...
            while(_loc2_ < m_memberNum)
            {
               ...
               if(m_memberNum == 3)
               {
                  dmy_char2.addChild(m_loaderAwakeR[_loc2_]);
               }
               _loc2_++;
            }
         });
