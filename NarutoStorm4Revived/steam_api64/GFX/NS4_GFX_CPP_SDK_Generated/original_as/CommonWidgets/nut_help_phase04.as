package script.duel_boss_help
{
   ...
   public class nut_help_phase04
   {
      ...
      public static const CCD_KEY_SKL:int = 2;
      
      public static const CCD_KEY_CHD:int = 3;
      
      public static const CCD_KEY_JMP:int = 4;
      
      public static const CCD_KEY_CHC:int = 5;
      
      public static const CCD_KEY_SRK:int = 6;
      
      public static const CCD_HELP_NUM:int = 7;
      
      private const CCD_HELP_MSG_1:String = "commandlist_demo_00";
      
      private const CCD_HELP_MSG_2:String = "commandlist_demo_08";
      
      private const CCD_HELP_MSG_3:String = "commandlist_demo_12";
      
      private const CCD_HELP_MSG_4:String = "commandlist_demo_14";
      
      private const CCD_HELP_MSG_5:String = "commandlist_demo_04";
      
      private const CCD_HELP_MSG_6:String = "commandlist_demo_17";
      
      private const CCD_HELP_MSG_7:String = "commandlist_demo_02";
      
      private const CCD_ATK_CMD:String = "commandlist_demo_01";
      
      private const CCD_SRK_CMD:String = "commandlist_demo_16";
      ...
      public function nut_help_phase04()
      {
         super();
         var _loc1_:int = 0;
         ...
         this.m_paramArr[CCD_KEY_SKL].m_msg = String(ExternalInterface.call("MessageConvert",this.CCD_HELP_MSG_3));
         this.m_paramArr[CCD_KEY_CHD].m_msg = String(ExternalInterface.call("MessageConvert",this.CCD_HELP_MSG_4));
         this.m_paramArr[CCD_KEY_JMP].m_msg = String(ExternalInterface.call("MessageConvert",this.CCD_HELP_MSG_5));
         this.m_paramArr[CCD_KEY_CHC].m_msg = String(ExternalInterface.call("MessageConvert",this.CCD_HELP_MSG_6));
         this.m_paramArr[CCD_KEY_SRK].m_msg = String(ExternalInterface.call("MessageConvert",this.CCD_HELP_MSG_7));
