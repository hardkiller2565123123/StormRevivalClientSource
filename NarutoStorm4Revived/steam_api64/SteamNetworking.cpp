...
static const char* NS4_DEFAULT_P2P_HOST = "127.0.0.1";
static const uint16_t NS4_DEFAULT_P2P_PORT = 47584;
...
private:
    bool EnsureSocket()
    {
        ...
        {
            Logger::Error("NS4SteamNetworking: socket creation failed");
            return false;
        }
        ...
        if (host.empty())
            host = NS4_DEFAULT_P2P_HOST;

        if (port == 0)
            port = NS4_DEFAULT_P2P_PORT;
        ...
        {
            Logger::Error("NS4SteamNetworking: invalid custom P2P host, falling back to 127.0.0.1");
            host = NS4_DEFAULT_P2P_HOST;
            inet_pton(AF_INET, host.c_str(), &serverAddress.sin_addr);
        }

        Logger::Info(
            "NS4SteamNetworking: custom LAN/Radmin endpoint " +
            host +
            ":" +
            std::to_string(port));
    ...
    void Poll()
    {
        ...
        for (;;)
        {
            ...
            Logger::Info(
                "NS4SteamNetworking: packet received size=" +
                std::to_string(size));
        }
    }
...
public:
        ...
        int channel)
    {
        ...
        Logger::Info(
            "NS4SteamNetworking: SendP2PPacket emulated size=" +
            std::to_string(size) +
            " channel=" +
        ...
        int channel)
    {
        ...
        {
            Logger::Info(
                "NS4SteamNetworking: ReadP2PPacket size=" +
    ...
    virtual bool AcceptP2PSessionWithUser(CSteamID steamIDRemote)
    {
        ...
        Logger::Info(
            "NS4SteamNetworking: AcceptP2PSessionWithUser " +
    ...
    virtual bool CloseP2PSessionWithUser(CSteamID steamIDRemote)
    {
        ...
        Logger::Info(
            "NS4SteamNetworking: CloseP2PSessionWithUser " +
            std::to_string(steamIDRemote));
    ...
    virtual bool CloseP2PChannelWithUser(CSteamID steamIDRemote, int channel)
    {
        ...
        Logger::Info(
            "NS4SteamNetworking: CloseP2PChannelWithUser " +
            std::to_string(steamIDRemote) +
            " channel=" +
            std::to_string(channel));
        ...
        P2PSessionState_t* state)
    {
        ...
        endpoint.sin_port = htons(port ? port : NS4_DEFAULT_P2P_PORT);

        if (host == "localhost" || host.empty())
            host = NS4_DEFAULT_P2P_HOST;

        if (inet_pton(AF_INET, host.c_str(), &endpoint.sin_addr) != 1)
            inet_pton(AF_INET, NS4_DEFAULT_P2P_HOST, &endpoint.sin_addr);
    ...
    virtual bool AllowP2PPacketRelay(bool allow)
    {
        ...
        Logger::Info(
            std::string("NS4SteamNetworking: AllowP2PPacketRelay ") +
            (allow ? "true" : "false"));
        ...
        bool relay)
    {
        ...
        Logger::Info("NS4SteamNetworking: CreateListenSocket");
        return 1;
    }
        ...
        bool relay)
    {
        ...
        Logger::Info(
            "NS4SteamNetworking: CreateP2PConnectionSocket " +
        ...
        int timeout)
    {
        ...
        Logger::Info("NS4SteamNetworking: CreateConnectionSocket");
        return 1;
    }
    ...
    virtual bool DestroySocket(SNetSocket_t socket, bool notifyRemote)
    {
        ...
        Logger::Info("NS4SteamNetworking: DestroySocket");
        return true;
    }
    ...
    virtual bool DestroyListenSocket(SNetListenSocket_t socket, bool notifyRemote)
    {
        ...
        Logger::Info("NS4SteamNetworking: DestroyListenSocket");
        return true;
    }
        ...
        bool reliable)
    {
        ...
        Logger::Info(
            "NS4SteamNetworking: SendDataOnSocket size=" +
            std::to_string(size));
        return true;
    }
...
class NS4SteamNetworkingMessages
{
public:
        ...
        int channel)
    {
        ...
        Logger::Info(
            "NS4SteamNetworkingMessages: SendMessageToUser size=" +
            std::to_string(size));
...
class NS4SteamNetworkingSockets
{
public:
    bool InitAuthentication()
    {
        Logger::Info("NS4SteamNetworkingSockets: InitAuthentication");
        return true;
    }
};

class NS4SteamNetworkingUtils
{
public:
    bool InitializeRelayAccess()
    {
        Logger::Info("NS4SteamNetworkingUtils: InitializeRelayAccess");
        return true;
    }
    ...
    int GetRelayNetworkStatus(void* details)
    {
        ...
        Logger::Info("NS4SteamNetworkingUtils: GetRelayNetworkStatus");
        return 1;
    }
};

static NS4SteamNetworking g_Networking;
static NS4SteamNetworkingMessages g_Messages;
static NS4SteamNetworkingSockets g_Sockets;
static NS4SteamNetworkingUtils g_Utils;

extern "C" void* __cdecl NS4Revived_SteamNetworking()
{
    SteamVersionLogger::LogInterfaceRequest("NS4Revived_SteamNetworking", "SteamNetworking006");
    return &g_Networking;
}

extern "C" void* __cdecl NS4Revived_SteamGameServerNetworking()
{
    SteamVersionLogger::LogInterfaceRequest("NS4Revived_SteamGameServerNetworking", "SteamNetworking006");
    return &g_Networking;
}

extern "C" void* __cdecl NS4Revived_SteamNetworkingMessages()
{
    SteamVersionLogger::LogInterfaceRequest("NS4Revived_SteamNetworkingMessages", "SteamNetworkingMessages002");
    return &g_Messages;
}

extern "C" void* __cdecl NS4Revived_SteamNetworkingSockets()
{
    SteamVersionLogger::LogInterfaceRequest("NS4Revived_SteamNetworkingSockets", "SteamNetworkingSockets012");
    return &g_Sockets;
}

extern "C" void* __cdecl NS4Revived_SteamGameServerNetworkingSockets()
{
    SteamVersionLogger::LogInterfaceRequest("NS4Revived_SteamGameServerNetworkingSockets", "SteamNetworkingSockets012");
    return &g_Sockets;
}

extern "C" void* __cdecl NS4Revived_SteamNetworkingUtils()
{
    SteamVersionLogger::LogInterfaceRequest("NS4Revived_SteamNetworkingUtils", "SteamNetworkingUtils004");
    return &g_Utils;
}
