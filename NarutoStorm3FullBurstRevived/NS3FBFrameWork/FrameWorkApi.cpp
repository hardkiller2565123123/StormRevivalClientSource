...
namespace
{
    ...
    void EnsureInitialized()
    {
        ...
        Logger::Init();
        Logger::Info("NS3FBFrameWork.dll add-on initialized");
        ...
        Logger::Info("NS3FBFrameWork.dll asset tools initialized");
        g_Initialized = true;
    }
}
...
{
    Logger::Info("NS3FBFrameWork.dll render-target reset requested; client owns the active swapchain.");
}
...
{
    return "NS3 Full Burst Revived FrameWork";
}
...
extern "C" __declspec(dllexport) void __cdecl Framework_OnClientGui()
{
    ...
    ImGui::Text("NS3FBFrameWork.dll Options");
    ImGui::Separator();
...
extern "C" __declspec(dllexport) void __cdecl Framework_OnClientShutdown()
{
    ...
    Logger::Info("NS3FBFrameWork.dll add-on shutdown");
    g_Initialized = false;
}
