...
extern "C" void* __cdecl NS3FBRevived_SteamNetworking();
extern "C" void* __cdecl NS3FBRevived_SteamGameServerNetworking();
extern "C" void* __cdecl NS3FBRevived_SteamNetworkingUtils();
extern "C" void* __cdecl NS3FBRevived_SteamNetworkingMessages();
extern "C" void* __cdecl NS3FBRevived_SteamNetworkingSockets();
extern "C" void* __cdecl NS3FBRevived_SteamGameServerNetworkingSockets();
...
extern "C" __declspec(dllexport) bool __cdecl SteamAPI_ISteamUser_GetUserDataFolder(void* self, char* buffer, int bufferSize)
{
    ...
    const std::string folder = (std::filesystem::path(FakeSteamCore::InstallPath()) / "NarutoStorm3FullBurstRevived" / "userdata").string();
...
extern "C" __declspec(dllexport) SteamAPICall_t __cdecl SteamAPI_ISteamUser_RequestEncryptedAppTicket(void* self, void* data, int dataSize)
{
    ...
    const char prefix[] = "NS3FBREVIVED_ENCRYPTED_APP_TICKET";
...
extern "C" __declspec(dllexport) void* __cdecl SteamAPI_ISteamClient_GetISteamNetworking(void* self, HSteamUser user, HSteamPipe pipe, const char* version)
{
    ...
    NSR_UNUSED(pipe);
    NSR_UNUSED(version);
    return NS3FBRevived_SteamNetworking();
}
...
extern "C" __declspec(dllexport) bool __cdecl SteamAPI_ISteamMatchmaking_GetFavoriteGame(void* self, int game, AppId_t* appID, uint32_t* ip, uint16_t* connPort, uint16_t* queryPort, uint32_t* flags, uint32_t* lastPlayed)
{
    NSR_UNUSED(self);
    NSR_UNUSED(game);
    FlatSafeWrite(appID, static_cast<AppId_t>(234670));
    FlatSafeWrite(ip, 0u);
...
// Custom networking
extern "C" __declspec(dllexport) void* __cdecl SteamNetworking() { SteamVersionLogger::LogExportRequest("SteamNetworking"); return NS3FBRevived_SteamNetworking(); }
extern "C" __declspec(dllexport) void* __cdecl SteamNetworkingMessages() { SteamVersionLogger::LogExportRequest("SteamNetworkingMessages"); return NS3FBRevived_SteamNetworkingMessages(); }
extern "C" __declspec(dllexport) void* __cdecl SteamNetworkingSockets() { SteamVersionLogger::LogExportRequest("SteamNetworkingSockets"); return NS3FBRevived_SteamNetworkingSockets(); }
extern "C" __declspec(dllexport) void* __cdecl SteamNetworkingUtils() { SteamVersionLogger::LogExportRequest("SteamNetworkingUtils"); return NS3FBRevived_SteamNetworkingUtils(); }
...
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamNetworking_v006, NS3FBRevived_SteamNetworking())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamNetworking_v005, NS3FBRevived_SteamNetworking())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamGameServerNetworking_v006, NS3FBRevived_SteamGameServerNetworking())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamGameServerNetworking_v005, NS3FBRevived_SteamGameServerNetworking())
...
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamNetworkingMessages_v002, NS3FBRevived_SteamNetworkingMessages())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamNetworkingMessages_SteamAPI_v002, NS3FBRevived_SteamNetworkingMessages())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamGameServerNetworkingMessages_v002, NS3FBRevived_SteamNetworkingMessages())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamGameServerNetworkingMessages_SteamAPI_v002, NS3FBRevived_SteamNetworkingMessages())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamNetworkingSockets_SteamAPI_v012, NS3FBRevived_SteamNetworkingSockets())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamGameServerNetworkingSockets_SteamAPI_v012, NS3FBRevived_SteamGameServerNetworkingSockets())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamNetworkingSockets_SteamAPI_v011, NS3FBRevived_SteamNetworkingSockets())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamGameServerNetworkingSockets_SteamAPI_v011, NS3FBRevived_SteamGameServerNetworkingSockets())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamNetworkingSockets_SteamAPI_v009, NS3FBRevived_SteamNetworkingSockets())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamGameServerNetworkingSockets_SteamAPI_v009, NS3FBRevived_SteamGameServerNetworkingSockets())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamNetworkingSockets_v009, NS3FBRevived_SteamNetworkingSockets())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamGameServerNetworkingSockets_v009, NS3FBRevived_SteamGameServerNetworkingSockets())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamNetworkingSockets_v008, NS3FBRevived_SteamNetworkingSockets())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamGameServerNetworkingSockets_v008, NS3FBRevived_SteamGameServerNetworkingSockets())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamNetworkingUtils_SteamAPI_v003, NS3FBRevived_SteamNetworkingUtils())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamNetworkingUtils_SteamAPI_v004, NS3FBRevived_SteamNetworkingUtils())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamNetworkingUtils_v003, NS3FBRevived_SteamNetworkingUtils())
...
extern "C" __declspec(dllexport) void* __cdecl SteamGameServerNetworking() { return NS3FBRevived_SteamGameServerNetworking(); }
extern "C" __declspec(dllexport) void* __cdecl SteamGameServerNetworkingSockets() { return NS3FBRevived_SteamGameServerNetworkingSockets(); }
