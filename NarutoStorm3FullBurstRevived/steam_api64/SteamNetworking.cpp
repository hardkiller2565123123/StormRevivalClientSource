...
static const char* NS3FB_DEFAULT_P2P_HOST = "127.0.0.1";
static const uint16_t NS3FB_DEFAULT_P2P_PORT = 47584;
...
private:
    bool EnsureSocket()
    {
        ...
        {
            Logger::Error("NS3FBSteamNetworking: socket creation failed");
            return false;
        }
        ...
        if (host.empty())
            host = NS3FB_DEFAULT_P2P_HOST;

        if (port == 0)
            port = NS3FB_DEFAULT_P2P_PORT;
        ...
        {
            Logger::Error("NS3FBSteamNetworking: invalid custom P2P host, falling back to 127.0.0.1");
            host = NS3FB_DEFAULT_P2P_HOST;
            inet_pton(AF_INET, host.c_str(), &serverAddress.sin_addr);
        }

        Logger::Info(
            "NS3FBSteamNetworking: custom LAN/Radmin endpoint " +
            host +
            ":" +
            std::to_string(port));
    ...
    void Poll()
    {
        ...
        for (;;)
        {
            ...
            Logger::Info(
                "NS3FBSteamNetworking: packet received size=" +
                std::to_string(size));
        }
    }
...
public:
        ...
        int channel)
    {
        ...
        Logger::Info(
            "NS3FBSteamNetworking: SendP2PPacket emulated size=" +
            std::to_string(size) +
            " channel=" +
        ...
        int channel)
    {
        ...
        {
            Logger::Info(
                "NS3FBSteamNetworking: ReadP2PPacket size=" +
    ...
    virtual bool AcceptP2PSessionWithUser(CSteamID steamIDRemote)
    {
        ...
        Logger::Info(
            "NS3FBSteamNetworking: AcceptP2PSessionWithUser " +
    ...
    virtual bool CloseP2PSessionWithUser(CSteamID steamIDRemote)
    {
        ...
        Logger::Info(
            "NS3FBSteamNetworking: CloseP2PSessionWithUser " +
            std::to_string(steamIDRemote));
    ...
    virtual bool CloseP2PChannelWithUser(CSteamID steamIDRemote, int channel)
    {
        ...
        Logger::Info(
            "NS3FBSteamNetworking: CloseP2PChannelWithUser " +
            std::to_string(steamIDRemote) +
            " channel=" +
            std::to_string(channel));
        ...
        P2PSessionState_t* state)
    {
        ...
        endpoint.sin_port = htons(port ? port : NS3FB_DEFAULT_P2P_PORT);

        if (host == "localhost" || host.empty())
            host = NS3FB_DEFAULT_P2P_HOST;

        if (inet_pton(AF_INET, host.c_str(), &endpoint.sin_addr) != 1)
            inet_pton(AF_INET, NS3FB_DEFAULT_P2P_HOST, &endpoint.sin_addr);
    ...
    virtual bool AllowP2PPacketRelay(bool allow)
    {
        ...
        Logger::Info(
            std::string("NS3FBSteamNetworking: AllowP2PPacketRelay ") +
            (allow ? "true" : "false"));
        ...
        bool relay)
    {
        ...
        Logger::Info("NS3FBSteamNetworking: CreateListenSocket");
        return 1;
    }
        ...
        bool relay)
    {
        ...
        Logger::Info(
            "NS3FBSteamNetworking: CreateP2PConnectionSocket " +
        ...
        int timeout)
    {
        ...
        Logger::Info("NS3FBSteamNetworking: CreateConnectionSocket");
        return 1;
    }
    ...
    virtual bool DestroySocket(SNetSocket_t socket, bool notifyRemote)
    {
        ...
        Logger::Info("NS3FBSteamNetworking: DestroySocket");
        return true;
    }
    ...
    virtual bool DestroyListenSocket(SNetListenSocket_t socket, bool notifyRemote)
    {
        ...
        Logger::Info("NS3FBSteamNetworking: DestroyListenSocket");
        return true;
    }
        ...
        bool reliable)
    {
        ...
        Logger::Info(
            "NS3FBSteamNetworking: SendDataOnSocket size=" +
            std::to_string(size));
        return true;
    }
        ...
        uint16_t* remotePort)
    {
        ...
        SafeWriteValue(remotePort, NS3FB_DEFAULT_P2P_PORT);
...
class NS3FBSteamNetworkingMessages
{
public:
        ...
        int channel)
    {
        ...
        Logger::Info(
            "NS3FBSteamNetworkingMessages: SendMessageToUser size=" +
            std::to_string(size));
...
class NS3FBSteamNetworkingSockets
{
public:
    bool InitAuthentication()
    {
        Logger::Info("NS3FBSteamNetworkingSockets: InitAuthentication");
        return true;
    }
};

class NS3FBSteamNetworkingUtils
{
public:
    bool InitializeRelayAccess()
    {
        Logger::Info("NS3FBSteamNetworkingUtils: InitializeRelayAccess");
        return true;
    }
    ...
    int GetRelayNetworkStatus(void* details)
    {
        ...
        Logger::Info("NS3FBSteamNetworkingUtils: GetRelayNetworkStatus");
        return 1;
    }
};

static NS3FBSteamNetworking g_Networking;
static NS3FBSteamNetworkingMessages g_Messages;
static NS3FBSteamNetworkingSockets g_Sockets;
static NS3FBSteamNetworkingUtils g_Utils;

extern "C" void* __cdecl NS3FBRevived_SteamNetworking()
{
    SteamVersionLogger::LogInterfaceRequest("NS3FBRevived_SteamNetworking", "SteamNetworking006");
    return &g_Networking;
}

extern "C" void* __cdecl NS3FBRevived_SteamGameServerNetworking()
{
    SteamVersionLogger::LogInterfaceRequest("NS3FBRevived_SteamGameServerNetworking", "SteamNetworking006");
    return &g_Networking;
}

extern "C" void* __cdecl NS3FBRevived_SteamNetworkingMessages()
{
    SteamVersionLogger::LogInterfaceRequest("NS3FBRevived_SteamNetworkingMessages", "SteamNetworkingMessages002");
    return &g_Messages;
}

extern "C" void* __cdecl NS3FBRevived_SteamNetworkingSockets()
{
    SteamVersionLogger::LogInterfaceRequest("NS3FBRevived_SteamNetworkingSockets", "SteamNetworkingSockets012");
    return &g_Sockets;
}

extern "C" void* __cdecl NS3FBRevived_SteamGameServerNetworkingSockets()
{
    SteamVersionLogger::LogInterfaceRequest("NS3FBRevived_SteamGameServerNetworkingSockets", "SteamNetworkingSockets012");
    return &g_Sockets;
}

extern "C" void* __cdecl NS3FBRevived_SteamNetworkingUtils()
{
    SteamVersionLogger::LogInterfaceRequest("NS3FBRevived_SteamNetworkingUtils", "SteamNetworkingUtils004");
    return &g_Utils;
}
