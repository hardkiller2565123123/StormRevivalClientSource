...
namespace
{
    constexpr const char* kMagic = "NS3FBREVIVED_LOBBY_V1";
    ...
    std::string HashPasswordInternal(const std::string& password, const std::string& roomCode)
    {
        ...
        std::string material = normalizedRoom + ":" + password + ":NS3FBREVIVED";
        ...
        const sockaddr_in& from)
    {
        ...
        record.Name = ReadString(values, "name", "NS3 Full Burst Revived LAN Lobby");
