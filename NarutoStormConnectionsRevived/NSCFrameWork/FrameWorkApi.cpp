...
namespace
{
    ...
    void EnsureInitialized()
    {
        ...
        Logger::Init();
        Logger::Info("NSCFrameWork.dll add-on initialized");
        ...
        Logger::Info("NSCFrameWork.dll asset tools initialized");
        g_Initialized = true;
    }
}
...
{
    Logger::Info("NSCFrameWork.dll render-target reset requested; client owns the active swapchain.");
}
...
extern "C" __declspec(dllexport) void __cdecl Framework_OnClientGui()
{
    ...
    ImGui::Text("NSCFrameWork.dll Options");
    ImGui::Separator();
...
extern "C" __declspec(dllexport) void __cdecl Framework_OnClientShutdown()
{
    ...
    Logger::Info("NSCFrameWork.dll add-on shutdown");
    g_Initialized = false;
}
