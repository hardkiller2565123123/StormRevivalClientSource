...
namespace
{
    constexpr const char* kMagic = "NSCREVIVED_LOBBY_V1";
    ...
    std::string HashPasswordInternal(const std::string& password, const std::string& roomCode)
    {
        ...
        std::string material = normalizedRoom + ":" + password + ":NSCREVIVED";
        ...
        const sockaddr_in& from)
    {
        ...
        record.Name = ReadString(values, "name", "NSC Revived LAN Lobby");
