...
static const char* NSC_DEFAULT_P2P_HOST = "127.0.0.1";
static const uint16_t NSC_DEFAULT_P2P_PORT = 47584;
...
private:
    bool EnsureSocket()
    {
        ...
        {
            Logger::Error("NSCSteamNetworking: socket creation failed");
            return false;
        }
        ...
        if (host.empty())
            host = NSC_DEFAULT_P2P_HOST;

        if (port == 0)
            port = NSC_DEFAULT_P2P_PORT;
        ...
        {
            Logger::Error("NSCSteamNetworking: invalid custom P2P host, falling back to 127.0.0.1");
            host = NSC_DEFAULT_P2P_HOST;
            inet_pton(AF_INET, host.c_str(), &serverAddress.sin_addr);
        }

        Logger::Info(
            "NSCSteamNetworking: custom LAN/Radmin endpoint " +
            host +
            ":" +
            std::to_string(port));
    ...
    void Poll()
    {
        ...
        for (;;)
        {
            ...
            Logger::Info(
                "NSCSteamNetworking: packet received size=" +
                std::to_string(size));
        }
    }
...
public:
        ...
        int channel)
    {
        ...
        Logger::Info(
            "NSCSteamNetworking: SendP2PPacket emulated size=" +
            std::to_string(size) +
            " channel=" +
        ...
        int channel)
    {
        ...
        {
            Logger::Info(
                "NSCSteamNetworking: ReadP2PPacket size=" +
    ...
    virtual bool AcceptP2PSessionWithUser(CSteamID steamIDRemote)
    {
        ...
        Logger::Info(
            "NSCSteamNetworking: AcceptP2PSessionWithUser " +
    ...
    virtual bool CloseP2PSessionWithUser(CSteamID steamIDRemote)
    {
        ...
        Logger::Info(
            "NSCSteamNetworking: CloseP2PSessionWithUser " +
            std::to_string(steamIDRemote));
    ...
    virtual bool CloseP2PChannelWithUser(CSteamID steamIDRemote, int channel)
    {
        ...
        Logger::Info(
            "NSCSteamNetworking: CloseP2PChannelWithUser " +
            std::to_string(steamIDRemote) +
            " channel=" +
            std::to_string(channel));
        ...
        P2PSessionState_t* state)
    {
        ...
        endpoint.sin_port = htons(port ? port : NSC_DEFAULT_P2P_PORT);

        if (host == "localhost" || host.empty())
            host = NSC_DEFAULT_P2P_HOST;

        if (inet_pton(AF_INET, host.c_str(), &endpoint.sin_addr) != 1)
            inet_pton(AF_INET, NSC_DEFAULT_P2P_HOST, &endpoint.sin_addr);
    ...
    virtual bool AllowP2PPacketRelay(bool allow)
    {
        ...
        Logger::Info(
            std::string("NSCSteamNetworking: AllowP2PPacketRelay ") +
            (allow ? "true" : "false"));
        ...
        bool relay)
    {
        ...
        Logger::Info("NSCSteamNetworking: CreateListenSocket");
        return 1;
    }
        ...
        bool relay)
    {
        ...
        Logger::Info(
            "NSCSteamNetworking: CreateP2PConnectionSocket " +
        ...
        int timeout)
    {
        ...
        Logger::Info("NSCSteamNetworking: CreateConnectionSocket");
        return 1;
    }
    ...
    virtual bool DestroySocket(SNetSocket_t socket, bool notifyRemote)
    {
        ...
        Logger::Info("NSCSteamNetworking: DestroySocket");
        return true;
    }
    ...
    virtual bool DestroyListenSocket(SNetListenSocket_t socket, bool notifyRemote)
    {
        ...
        Logger::Info("NSCSteamNetworking: DestroyListenSocket");
        return true;
    }
        ...
        bool reliable)
    {
        ...
        Logger::Info(
            "NSCSteamNetworking: SendDataOnSocket size=" +
            std::to_string(size));
        return true;
    }
        ...
        uint16_t* remotePort)
    {
        ...
        SafeWriteValue(remotePort, NSC_DEFAULT_P2P_PORT);
...
class NSCSteamNetworkingMessages
{
public:
        ...
        int channel)
    {
        ...
        Logger::Info(
            "NSCSteamNetworkingMessages: SendMessageToUser size=" +
            std::to_string(size));
...
class NSCSteamNetworkingSockets
{
public:
    bool InitAuthentication()
    {
        Logger::Info("NSCSteamNetworkingSockets: InitAuthentication");
        return true;
    }
};

class NSCSteamNetworkingUtils
{
public:
    bool InitializeRelayAccess()
    {
        Logger::Info("NSCSteamNetworkingUtils: InitializeRelayAccess");
        return true;
    }
    ...
    int GetRelayNetworkStatus(void* details)
    {
        ...
        Logger::Info("NSCSteamNetworkingUtils: GetRelayNetworkStatus");
        return 1;
    }
};

static NSCSteamNetworking g_Networking;
static NSCSteamNetworkingMessages g_Messages;
static NSCSteamNetworkingSockets g_Sockets;
static NSCSteamNetworkingUtils g_Utils;

extern "C" void* __cdecl NSCRevived_SteamNetworking()
{
    SteamVersionLogger::LogInterfaceRequest("NSCRevived_SteamNetworking", "SteamNetworking006");
    return &g_Networking;
}

extern "C" void* __cdecl NSCRevived_SteamGameServerNetworking()
{
    SteamVersionLogger::LogInterfaceRequest("NSCRevived_SteamGameServerNetworking", "SteamNetworking006");
    return &g_Networking;
}

extern "C" void* __cdecl NSCRevived_SteamNetworkingMessages()
{
    SteamVersionLogger::LogInterfaceRequest("NSCRevived_SteamNetworkingMessages", "SteamNetworkingMessages002");
    return &g_Messages;
}

extern "C" void* __cdecl NSCRevived_SteamNetworkingSockets()
{
    SteamVersionLogger::LogInterfaceRequest("NSCRevived_SteamNetworkingSockets", "SteamNetworkingSockets012");
    return &g_Sockets;
}

extern "C" void* __cdecl NSCRevived_SteamGameServerNetworkingSockets()
{
    SteamVersionLogger::LogInterfaceRequest("NSCRevived_SteamGameServerNetworkingSockets", "SteamNetworkingSockets012");
    return &g_Sockets;
}

extern "C" void* __cdecl NSCRevived_SteamNetworkingUtils()
{
    SteamVersionLogger::LogInterfaceRequest("NSCRevived_SteamNetworkingUtils", "SteamNetworkingUtils004");
    return &g_Utils;
}
