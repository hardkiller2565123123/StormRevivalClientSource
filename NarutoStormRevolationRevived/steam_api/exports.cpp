...
extern "C" void* __cdecl NSRRevived_SteamNetworking();
extern "C" void* __cdecl NSRRevived_SteamGameServerNetworking();
extern "C" void* __cdecl NSRRevived_SteamNetworkingUtils();
extern "C" void* __cdecl NSRRevived_SteamNetworkingMessages();
extern "C" void* __cdecl NSRRevived_SteamNetworkingSockets();
extern "C" void* __cdecl NSRRevived_SteamGameServerNetworkingSockets();
...
extern "C" __declspec(dllexport) bool __cdecl SteamAPI_ISteamUser_GetUserDataFolder(void* self, char* buffer, int bufferSize)
{
    ...
    const std::string folder = (std::filesystem::path(FakeSteamCore::InstallPath()) / "NarutoStormRevolationRevived" / "userdata").string();
...
extern "C" __declspec(dllexport) SteamAPICall_t __cdecl SteamAPI_ISteamUser_RequestEncryptedAppTicket(void* self, void* data, int dataSize)
{
    ...
    const char prefix[] = "NSRREVIVED_ENCRYPTED_APP_TICKET";
...
extern "C" __declspec(dllexport) void* __cdecl SteamAPI_ISteamClient_GetISteamNetworking(void* self, HSteamUser user, HSteamPipe pipe, const char* version)
{
    ...
    NSR_UNUSED(pipe);
    NSR_UNUSED(version);
    return NSRRevived_SteamNetworking();
}
...
extern "C" __declspec(dllexport) bool __cdecl SteamAPI_ISteamMatchmaking_GetFavoriteGame(void* self, int game, AppId_t* appID, uint32_t* ip, uint16_t* connPort, uint16_t* queryPort, uint32_t* flags, uint32_t* lastPlayed)
{
    NSR_UNUSED(self);
    NSR_UNUSED(game);
    FlatSafeWrite(appID, static_cast<AppId_t>(272510));
    FlatSafeWrite(ip, 0u);
...
// Custom networking
extern "C" __declspec(dllexport) void* __cdecl SteamNetworking() { SteamVersionLogger::LogExportRequest("SteamNetworking"); return NSRRevived_SteamNetworking(); }
extern "C" __declspec(dllexport) void* __cdecl SteamNetworkingMessages() { SteamVersionLogger::LogExportRequest("SteamNetworkingMessages"); return NSRRevived_SteamNetworkingMessages(); }
extern "C" __declspec(dllexport) void* __cdecl SteamNetworkingSockets() { SteamVersionLogger::LogExportRequest("SteamNetworkingSockets"); return NSRRevived_SteamNetworkingSockets(); }
extern "C" __declspec(dllexport) void* __cdecl SteamNetworkingUtils() { SteamVersionLogger::LogExportRequest("SteamNetworkingUtils"); return NSRRevived_SteamNetworkingUtils(); }
...
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamNetworking_v006, NSRRevived_SteamNetworking())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamNetworking_v005, NSRRevived_SteamNetworking())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamGameServerNetworking_v006, NSRRevived_SteamGameServerNetworking())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamGameServerNetworking_v005, NSRRevived_SteamGameServerNetworking())
...
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamNetworkingMessages_v002, NSRRevived_SteamNetworkingMessages())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamNetworkingMessages_SteamAPI_v002, NSRRevived_SteamNetworkingMessages())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamGameServerNetworkingMessages_v002, NSRRevived_SteamNetworkingMessages())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamGameServerNetworkingMessages_SteamAPI_v002, NSRRevived_SteamNetworkingMessages())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamNetworkingSockets_SteamAPI_v012, NSRRevived_SteamNetworkingSockets())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamGameServerNetworkingSockets_SteamAPI_v012, NSRRevived_SteamGameServerNetworkingSockets())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamNetworkingSockets_SteamAPI_v011, NSRRevived_SteamNetworkingSockets())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamGameServerNetworkingSockets_SteamAPI_v011, NSRRevived_SteamGameServerNetworkingSockets())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamNetworkingSockets_SteamAPI_v009, NSRRevived_SteamNetworkingSockets())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamGameServerNetworkingSockets_SteamAPI_v009, NSRRevived_SteamGameServerNetworkingSockets())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamNetworkingSockets_v009, NSRRevived_SteamNetworkingSockets())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamGameServerNetworkingSockets_v009, NSRRevived_SteamGameServerNetworkingSockets())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamNetworkingSockets_v008, NSRRevived_SteamNetworkingSockets())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamGameServerNetworkingSockets_v008, NSRRevived_SteamGameServerNetworkingSockets())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamNetworkingUtils_SteamAPI_v003, NSRRevived_SteamNetworkingUtils())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamNetworkingUtils_SteamAPI_v004, NSRRevived_SteamNetworkingUtils())
EXPORT_STEAM_ACCESSOR(SteamAPI_SteamNetworkingUtils_v003, NSRRevived_SteamNetworkingUtils())
...
extern "C" __declspec(dllexport) void* __cdecl SteamGameServerNetworking() { return NSRRevived_SteamGameServerNetworking(); }
extern "C" __declspec(dllexport) void* __cdecl SteamGameServerNetworkingSockets() { return NSRRevived_SteamGameServerNetworkingSockets(); }
