...
namespace
{
    constexpr const char* kMagic = "NSRREVIVED_LOBBY_V1";
    ...
    std::string HashPasswordInternal(const std::string& password, const std::string& roomCode)
    {
        ...
        std::string material = normalizedRoom + ":" + password + ":NSRREVIVED";
        ...
        const sockaddr_in& from)
    {
        ...
        record.Name = ReadString(values, "name", "NSR Revived LAN Lobby");
