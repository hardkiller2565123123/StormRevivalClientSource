...
static const char* NSR_DEFAULT_P2P_HOST = "127.0.0.1";
static const uint16_t NSR_DEFAULT_P2P_PORT = 47584;
...
private:
    bool EnsureSocket()
    {
        ...
        {
            Logger::Error("NSRSteamNetworking: socket creation failed");
            return false;
        }
        ...
        if (host.empty())
            host = NSR_DEFAULT_P2P_HOST;

        if (port == 0)
            port = NSR_DEFAULT_P2P_PORT;
        ...
        {
            Logger::Error("NSRSteamNetworking: invalid custom P2P host, falling back to 127.0.0.1");
            host = NSR_DEFAULT_P2P_HOST;
            inet_pton(AF_INET, host.c_str(), &serverAddress.sin_addr);
        }

        Logger::Info(
            "NSRSteamNetworking: custom LAN/Radmin endpoint " +
            host +
            ":" +
            std::to_string(port));
    ...
    void Poll()
    {
        ...
        for (;;)
        {
            ...
            Logger::Info(
                "NSRSteamNetworking: packet received size=" +
                std::to_string(size));
        }
    }
...
public:
        ...
        int channel)
    {
        ...
        Logger::Info(
            "NSRSteamNetworking: SendP2PPacket emulated size=" +
            std::to_string(size) +
            " channel=" +
        ...
        int channel)
    {
        ...
        {
            Logger::Info(
                "NSRSteamNetworking: ReadP2PPacket size=" +
    ...
    virtual bool AcceptP2PSessionWithUser(CSteamID steamIDRemote)
    {
        ...
        Logger::Info(
            "NSRSteamNetworking: AcceptP2PSessionWithUser " +
    ...
    virtual bool CloseP2PSessionWithUser(CSteamID steamIDRemote)
    {
        ...
        Logger::Info(
            "NSRSteamNetworking: CloseP2PSessionWithUser " +
            std::to_string(steamIDRemote));
    ...
    virtual bool CloseP2PChannelWithUser(CSteamID steamIDRemote, int channel)
    {
        ...
        Logger::Info(
            "NSRSteamNetworking: CloseP2PChannelWithUser " +
            std::to_string(steamIDRemote) +
            " channel=" +
            std::to_string(channel));
        ...
        P2PSessionState_t* state)
    {
        ...
        endpoint.sin_port = htons(port ? port : NSR_DEFAULT_P2P_PORT);

        if (host == "localhost" || host.empty())
            host = NSR_DEFAULT_P2P_HOST;

        if (inet_pton(AF_INET, host.c_str(), &endpoint.sin_addr) != 1)
            inet_pton(AF_INET, NSR_DEFAULT_P2P_HOST, &endpoint.sin_addr);
    ...
    virtual bool AllowP2PPacketRelay(bool allow)
    {
        ...
        Logger::Info(
            std::string("NSRSteamNetworking: AllowP2PPacketRelay ") +
            (allow ? "true" : "false"));
        ...
        bool relay)
    {
        ...
        Logger::Info("NSRSteamNetworking: CreateListenSocket");
        return 1;
    }
        ...
        bool relay)
    {
        ...
        Logger::Info(
            "NSRSteamNetworking: CreateP2PConnectionSocket " +
        ...
        int timeout)
    {
        ...
        Logger::Info("NSRSteamNetworking: CreateConnectionSocket");
        return 1;
    }
    ...
    virtual bool DestroySocket(SNetSocket_t socket, bool notifyRemote)
    {
        ...
        Logger::Info("NSRSteamNetworking: DestroySocket");
        return true;
    }
    ...
    virtual bool DestroyListenSocket(SNetListenSocket_t socket, bool notifyRemote)
    {
        ...
        Logger::Info("NSRSteamNetworking: DestroyListenSocket");
        return true;
    }
        ...
        bool reliable)
    {
        ...
        Logger::Info(
            "NSRSteamNetworking: SendDataOnSocket size=" +
            std::to_string(size));
        return true;
    }
        ...
        uint16_t* remotePort)
    {
        ...
        SafeWriteValue(remotePort, NSR_DEFAULT_P2P_PORT);
...
class NSRSteamNetworkingMessages
{
public:
        ...
        int channel)
    {
        ...
        Logger::Info(
            "NSRSteamNetworkingMessages: SendMessageToUser size=" +
            std::to_string(size));
...
class NSRSteamNetworkingSockets
{
public:
    bool InitAuthentication()
    {
        Logger::Info("NSRSteamNetworkingSockets: InitAuthentication");
        return true;
    }
};

class NSRSteamNetworkingUtils
{
public:
    bool InitializeRelayAccess()
    {
        Logger::Info("NSRSteamNetworkingUtils: InitializeRelayAccess");
        return true;
    }
    ...
    int GetRelayNetworkStatus(void* details)
    {
        ...
        Logger::Info("NSRSteamNetworkingUtils: GetRelayNetworkStatus");
        return 1;
    }
};

static NSRSteamNetworking g_Networking;
static NSRSteamNetworkingMessages g_Messages;
static NSRSteamNetworkingSockets g_Sockets;
static NSRSteamNetworkingUtils g_Utils;

extern "C" void* __cdecl NSRRevived_SteamNetworking()
{
    SteamVersionLogger::LogInterfaceRequest("NSRRevived_SteamNetworking", "SteamNetworking006");
    return &g_Networking;
}

extern "C" void* __cdecl NSRRevived_SteamGameServerNetworking()
{
    SteamVersionLogger::LogInterfaceRequest("NSRRevived_SteamGameServerNetworking", "SteamNetworking006");
    return &g_Networking;
}

extern "C" void* __cdecl NSRRevived_SteamNetworkingMessages()
{
    SteamVersionLogger::LogInterfaceRequest("NSRRevived_SteamNetworkingMessages", "SteamNetworkingMessages002");
    return &g_Messages;
}

extern "C" void* __cdecl NSRRevived_SteamNetworkingSockets()
{
    SteamVersionLogger::LogInterfaceRequest("NSRRevived_SteamNetworkingSockets", "SteamNetworkingSockets012");
    return &g_Sockets;
}

extern "C" void* __cdecl NSRRevived_SteamGameServerNetworkingSockets()
{
    SteamVersionLogger::LogInterfaceRequest("NSRRevived_SteamGameServerNetworkingSockets", "SteamNetworkingSockets012");
    return &g_Sockets;
}

extern "C" void* __cdecl NSRRevived_SteamNetworkingUtils()
{
    SteamVersionLogger::LogInterfaceRequest("NSRRevived_SteamNetworkingUtils", "SteamNetworkingUtils004");
    return &g_Utils;
}
