...
namespace
{
    ...
    void EnsureInitialized()
    {
        ...
        Logger::Init();
        Logger::Info("NSRFrameWork.dll add-on initialized");
        ...
        Logger::Info("NSRFrameWork.dll asset tools initialized");
        g_Initialized = true;
    }
}
...
{
    Logger::Info("NSRFrameWork.dll render-target reset requested; client owns the active swapchain.");
}
...
extern "C" __declspec(dllexport) void __cdecl Framework_OnClientGui()
{
    ...
    ImGui::Text("NSRFrameWork.dll Options");
    ImGui::Separator();
...
extern "C" __declspec(dllexport) void __cdecl Framework_OnClientShutdown()
{
    ...
    Logger::Info("NSRFrameWork.dll add-on shutdown");
    g_Initialized = false;
}
